...
def generate_chart(analyzer, scenario: str, output_dir: str):
    ...
    net_per_kwh = _compute_net_per_kwh(
        scenario, plot_df[cap_col].values, revenues,
        baseline_rev, baseline_sp, baseline_fp,
        spot_costs, fix_costs, has_spot, has_fix, fix_contract,
    )
...
def _compute_net_per_kwh(scenario, cap_vals, revenues, baseline_rev,
                          baseline_sp, baseline_fp, spot_costs, fix_costs,
                          has_spot, has_fix, fix_contract):
